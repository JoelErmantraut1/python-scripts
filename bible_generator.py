...
This program generates a bible in "xmm" format, parsing it from a
WEB page. Take care that it is needed to it that the WEB page keeps
the same format. So, if it was changed, this will not work.
"""
...
def get_verses(file, book, cap):
    ...
    try:
        verses.pop(1) # The last item only is the chapter name 
    except IndexError:
        pass
